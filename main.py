...
def run_main_pipeline(seed_data: bool = False):
    ...
    **Only return the category name** and nothing else.
    ...
    df_sample ['mistral_response'] = get_zero_shot_mistral_response(
        lcpp_llm,
        narratives,
        system_message,
        zero_shot_prompt_template
    ...
    pd.set_option('display.max_colwidth', DISPLAY_WIDTH)
    ...
    start_time = start_timer()
    df_sample['mistral_response'] = get_few_shot_mistral_response(
        lcpp_llm,
        narratives,
        few_shot_prompt,
        prediction_template
    ...
    start_time = start_timer()
    df_gold_examples['mistral_response'] = get_zero_shot_mistral_response(
        lcpp_llm,
        narratives,
        system_message,
        zero_shot_prompt_template
